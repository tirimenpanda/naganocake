...
Item.create( genre_id: 7, name: %?当店おすすめの、ケーキに合うスパークリングワインです。是非ともご一緒にお求めくださいませ。?, introduction: %??, listed_price: 5800, image: File.open( './app/assets/images/sparkling_wine1.png', ?r ) )
Item.create( genre_id: 7, name: %?当店おすすめの、ケーキに合うスパークリングワインです。豪華な宴会にでもどうぞ。?, introduction: %??, listed_price: 30_000, image: File.open( './app/assets/images/sparkling_wine2.png', ?r ) )
